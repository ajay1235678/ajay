...
TOKEN = '7545348012:AAF2rIHbzAw3s1rIQ2ZbpbuzgNH_8fsh76g' #Enter_Bot_Token_within_the_colons'
MONGO_URI = 'mongodb+srv://deepaidb:51354579914@deepaidb.imzonfj.mongodb.net/?retryWrites=true&w=majority&appName=deepaidb'
FORWARD_CHANNEL_ID = -1002375284981       # enter the log channel id
CHANNEL_ID = -1002375284981        # enter the log channel id
error_channel_id = -1002375284981        # enter the log channel id
